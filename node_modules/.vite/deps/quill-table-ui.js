...
// node_modules/quill-table-ui/dist/index.js
...
var QuillEvents;
(function(QuillEvents2) {
  QuillEvents2["EDITOR_CHANGE"] = "editor-change";
  QuillEvents2["SCROLL_BEFORE_UPDATE"] = "scroll-before-update";
  QuillEvents2["SCROLL_BLOT_MOUNT"] = "scroll-blot-mount";
  QuillEvents2["SCROLL_BLOT_UNMOUNT"] = "scroll-blot-unmount";
  QuillEvents2["SCROLL_OPTIMIZE"] = "scroll-optimize";
  QuillEvents2["SCROLL_UPDATE"] = "scroll-update";
  QuillEvents2["SELECTION_CHANGE"] = "selection-change";
  QuillEvents2["TEXT_CHANGE"] = "text-change";
})(QuillEvents || (QuillEvents = {}));
var QuillSources;
(function(QuillSources2) {
  QuillSources2["API"] = "api";
  QuillSources2["SILENT"] = "silent";
  QuillSources2["USER"] = "user";
...
var TableUI = (
  /** @class */
  function() {
    function TableUI2(quill, options) {
      var _this = this;
    ...
    TableUI2.prototype.isTable = function(range) {
      if (!range) {
    ...
    TableUI2.prototype.getColCount = function(range) {
      if (range === void 0) {
        range = null;
      }
      if (!range) {
    ...
    TableUI2.prototype.showMenu = function() {
      var _this = this;
      this.hideMenu();
    ...
    TableUI2.prototype.hideMenu = function() {
      if (this.menu) {
        this.menu.remove();
        this.menu = null;
    ...
    TableUI2.prototype.createMenuItem = function(item) {
      var _this = this;
    ...
    TableUI2.prototype.detectButton = function(range) {
      if (range == null) {
        return;
      }
    ...
    TableUI2.prototype.showToggle = function(position) {
    ...
    TableUI2.prototype.hideToggle = function() {
      this.toggle.classList.add("ql-table-toggle_hidden");
    };
    TableUI2.prototype.toggleMenu = function() {
      if (this.menu) {
        this.hideToggle();
      } else {
        this.showMenu();
    ...
    TableUI2.prototype.destroy = function() {
      this.hideMenu();
...
var dist_default = TableUI;
export {
  dist_default as default
};
//# sourceMappingURL=quill-table-ui.js.map
